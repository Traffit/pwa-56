...
const reviews_data = [
  {
    ...
    name: "Liam Smith",
    comment:
      "Cosa c'è di meglio che indulgere in dolci e vincere alla grande? Aviator è il mio preferito per le vittorie più dolci!",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Olivia Tremblay",
    comment:
      "Gioco a Aviator da settimane - è semplicemente avvincente! Vittorie costanti e tantissimi giri gratuiti. Amo assolutamente questa slot machine!",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Noah MacKenzie",
    comment:
      "Questo gioco è una vera esplosione di zucchero e adrenalina! I colori vivaci e l'azione continua di Aviator lo rendono un piacere coinvolgente.",
  },
  {
    img: "../../media/photos/comments/comment4.png",
    name: "Emma Gagnon",
    comment:
      "Aviator è una delizia per gli occhi e una gioia per il portafoglio! Amo l'emozione costante delle vittorie consecutive e l'abbondanza di giri gratuiti.",
  },
  {
    img: "../../media/photos/comments/comment5.png",
    name: "Lucas Leblanc",
    comment:
      "Non posso fare a meno di questo gioco a tema dolci! Aviator è il mio piacere segreto con le sue grafiche fantastiche e il potenziale per grandi vincite.",
  },
  {
    img: "../../media/photos/comments/comment6.png",
    name: "Ava Dubois",
    comment:
      "Questo gioco è come un negozio di caramelle pieno di vincite! I giri gratuiti di Aviator portano sempre queste vittorie deliziose.",
  },
  {
    img: "../../media/photos/comments/comment7.png",
    name: "Ethan Roy",
    comment:
      "Sono assolutamente dipendente da Aviator! L'emozione delle vittorie consecutive con la funzione Tumble è insuperabile.",
  },
  {
    img: "../../media/photos/comments/comment8.png",
    name: "Charlotte Lefebvre",
    comment:
      "Aviator soddisfa sia la mia voglia di dolci che la mia sete di vincite. È una fantastica combinazione di divertimento e potenziale per grandi pagamenti.",
  },
  {
    img: "../../media/photos/comments/comment9.png",
    name: "Benjamin Beaulieu",
    comment:
      "Un gioco così divertente! I giri gratuiti di Aviator mi fanno sempre tornare e gli effetti visivi sono semplicemente incantevoli.",
  },
  {
    img: "../../media/photos/comments/comment10.png",
    name: "Sophia Caron",
    comment:
      "Aviator non delude mai! Amo l'adrenalina quando le vittorie consecutive continuano a venire. Altamente raccomandato!",
  },
];
